  ...
  return (
    <main className="min-h-[100dvh] bg-[var(--inv-bg)] pb-28 animate-page-enter">
      ...
      <div className="px-6 text-[15px] leading-relaxed text-[var(--inv-body)]">
        ...
        <p className="mb-6">By using Narrative, you agree to these Terms of Service. If you do not agree, please do not use the app.</p>

        <h2 className="text-[18px] font-semibold text-[var(--inv-heading)] mb-3">Use of the App</h2>
        <p className="mb-4">Narrative is an interactive storytelling app. You may use it for personal, non-commercial purposes. You agree not to misuse the service, attempt to gain unauthorized access, or interfere with other users' experience.</p>
        <p className="mb-6">You must be at least 13 years old to use Narrative.</p>
        ...
        <p className="mb-6">Narrative may offer in-app purchases for hearts, perks, and story content. All purchases are final and non-refundable except as required by applicable law. Virtual currency and items have no real-world monetary value.</p>

        <h2 className="text-[18px] font-semibold text-[var(--inv-heading)] mb-3">Content</h2>
        <p className="mb-6">All stories, videos, and content within Narrative are owned by us or our licensors. You may not copy, distribute, or create derivative works from our content without permission.</p>

        <h2 className="text-[18px] font-semibold text-[var(--inv-heading)] mb-3">Limitation of Liability</h2>
        <p className="mb-6">Narrative is provided "as is" without warranties. We are not liable for any indirect, incidental, or consequential damages arising from your use of the app.</p>
        ...
        <p className="mb-6">Questions? Contact us at <span className="text-[var(--inv-accent)]">support@narrative.app</span></p>
      </div>
    </main>
  )
}
