      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4">
        ...
        {view !== 'check-email' && (
          <div className="text-center mb-14">
            ...
            <p className="text-white/50 text-[18px] leading-relaxed animate-fade-up" style={{ animationDelay: '0.5s', maxWidth: '220px' }}>Interactive stories that respond to you</p>
          </div>
        )}
