        ...
        <div className="relative px-5 pb-[max(env(safe-area-inset-bottom),16px)]">
          ...
          {node.ending && showChoices ? (
            ...
            <div>
              ...
              {/* Perk action buttons */}
              <div className="flex items-stretch gap-2 mt-8 animate-fade-up" style={{ animationDelay: '0.2s' }}>
                  {[
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl cursor-pointer transition-[opacity,transform,background-color] duration-200 active:scale-[0.96] disabled:opacity-30 disabled:cursor-not-allowed"
